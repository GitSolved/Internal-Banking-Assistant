...
class TestFullIntegration:
    ...
    async def test_service_dependency_injection(self):
        ...
        try:
            ...
            assert feeds_service.max_items == 1000  # Updated default value
    ...
    async def test_background_service_lifecycle(self):
        ...
        try:
            from internal_assistant.server.feeds.background_refresh import (
            ...
            background_service = BackgroundRefreshService(
                feeds_service, refresh_interval_minutes=1
            )
            ...
            with patch.object(
                ...
                with patch.object(
                    feeds_service, "__aenter__", return_value=feeds_service
                ):
        ...
        try:
            ...
            with patch("aiohttp.ClientSession.get") as mock_get:
                ...
                async with feeds_service:
                    result = await feeds_service.fetch_feed(
    ...
    def test_security_considerations(self):
        ...
        try:
            ...
            with open(router_file_path, encoding="utf-8") as f:
    ...
    def test_configuration_validation(self):
        ...
        try:
            ...
            required_deps = ["feedparser", "aiohttp", "beautifulsoup4"]
