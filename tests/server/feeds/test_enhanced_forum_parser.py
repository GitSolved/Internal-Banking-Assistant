...
def test_comprehensive_html_parsing():
    ...
    assert (
        len(forums) >= 4
    ), f"Expected at least 4 forums, found {len(forums)}"  # Should find at least 4 valid forums
...
async def test_service_integration():
    ...
    service.last_refresh = service.last_refresh or datetime.now(UTC)
...
def main():
    ...
    try:
        ...
        test_comprehensive_html_parsing()
