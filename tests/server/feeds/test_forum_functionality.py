...
def test_forum_link_functionality():
    ...
    # Valid link
    valid_link = ForumLink("Tech Forum", "https://techforum.onion", "Technology discussions", "Technology")
...
def test_forum_service_initialization():
    ...
    service.last_refresh = datetime.now(timezone.utc) - timedelta(hours=7)
    assert service.is_cache_valid() == False
...
def test_forum_service_filtering():
    ...
    # Set up test data
    test_forums = [
        ForumLink("Python Programming", "https://python.onion", "Python coding discussions", "Technology"),
        ForumLink("Web Development", "https://webdev.onion", "HTML, CSS, JavaScript", "Technology"),
        ForumLink("General Chat", "https://general.onion", "Random discussions", "General"),
        ForumLink("Crypto Discussion", "https://crypto.onion", "Cryptocurrency talk", "Finance")
    ]
