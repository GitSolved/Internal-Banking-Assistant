...
class TestForumDirectoryParser:
    ...
    def test_is_safe_forum(self):
        ...
        # Safe forum
        safe_forum = ForumLink("Tech Discussion", "https://example.com", "Technology forum")
        assert self.parser._is_safe_forum(safe_forum) is True
        
        # Unsafe forum
        unsafe_forum = ForumLink("Drug Market", "https://example.com", "Illegal marketplace")
...
class TestForumDirectoryService:
    ...
    def test_cache_validity(self):
        ...
        self.service.last_refresh = datetime.now(timezone.utc)
        assert self.service.is_cache_valid() is True
        
        # Expired cache
        self.service.last_refresh = datetime.now(timezone.utc) - timedelta(hours=2)
        assert self.service.is_cache_valid() is False
    ...
    def test_get_forums_filtering(self):
        ...
        self.service.forums_cache = [
            ...
            ForumLink("General Chat", "https://general.com", "General discussion", "General"),
    ...
    def test_search_forums(self):
        ...
        self.service.forums_cache = [
            ForumLink("Python Programming", "https://python.com", "Python coding", "Tech"),
            ForumLink("Web Development", "https://web.com", "HTML, CSS, JS", "Tech"),
            ForumLink("General Chat", "https://general.com", "Random discussions", "General"),
        ]
        self.service.last_refresh = datetime.now(timezone.utc)
