        ...
        match settings.vectorstore.database:
            ...
            case "chroma":
                try:
                    ...
                    from internal_assistant.components.vector_store.batched_chroma import (
            ...
            case "milvus":
                ...
                if settings.milvus is None:
                    logger.info(
                        ...
                        "Trying to connect to Milvus at local_data/internal_assistant/milvus/milvus_local.db "
