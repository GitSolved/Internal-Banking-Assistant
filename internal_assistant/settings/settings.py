...
class RerankSettings(BaseModel):
    enabled: bool = Field(
        False,
        description="If set to True, the RAG pipeline will use reranking to improve the quality of the retrieved documents.",
    )
    top_n: int = Field(
        2,
...
class MilvusSettings(BaseModel):
    uri: str = Field(
        "local_data/internal_assistant/milvus/milvus_local.db",
        description="The URI of the Milvus instance. For example: 'local_data/internal_assistant/milvus/milvus_local.db' for Milvus Lite.",
    )
    token: str = Field(
        "",
        description=(
